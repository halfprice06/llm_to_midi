...
class LlmResponseParser:
    ...
    def GenerateCompositionPlan(
      ...
      return cast(types.CompositionPlanWithMetadata, parsed)
    ...
    def GenerateOneSection(
      ...
      return cast(types.Section, parsed)
...
class LlmStreamParser:
    ...
    def GenerateCompositionPlan(
        ...
        llm_response: str,
        baml_options: BamlCallOptions = {},
    ) -> partial_types.CompositionPlanWithMetadata:
      __tb__ = baml_options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      else:
      ...
      return cast(partial_types.CompositionPlanWithMetadata, parsed)
    
    def GenerateOneSection(
        self,
        llm_response: str,
        baml_options: BamlCallOptions = {},
    ) -> partial_types.Section:
      __tb__ = baml_options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      else:
      ...
      return cast(partial_types.Section, parsed)
