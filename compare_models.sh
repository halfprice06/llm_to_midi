...
python main.py --models "AnthropicSonnet37,OpenAIGPT4o,AnthropicHaiku" --theme "Create a playful piano piece with a clear melodic theme and variations. Use a fast tempo and bright major key."
